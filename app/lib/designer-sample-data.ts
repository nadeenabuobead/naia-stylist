    ...
    designActions: [
      {
        ...
        product: SEEN,
        collection: "workwear",
        observedEvidence: `Corporate Chic customers: 100% feeling achievement (${pm[SEEN].wrCount}/${pm[SEEN].wrCount} post-wear) · +${pm[SEEN].avgConfidenceLift} confidence lift · Powerful + Confident outcomes confirmed`,
  ...
  const opportunityFeed = [
    {
      ...
      evidence: `${pm[SEEN].sessionCount} sessions · ${pm[SEEN].buyCount} Buy/Skip buy-intent outcome${pm[SEEN].buyCount !== 1 ? "s" : ""} · ★${pm[SEEN].avgRating} avg (${pm[SEEN].sampleSize} review${pm[SEEN].sampleSize !== 1 ? "s" : ""}) · ${Math.round(pm[SEEN].rewearRate * 100)}% rewear (${pm[SEEN].wrCount}/${pm[SEEN].wrCount} post-wear)`,
