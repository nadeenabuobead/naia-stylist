...
export const quizQuestions: QuizQuestion[] = [
  ...
  // SCREEN 3 — STYLE EXPRESSION (what clothes should communicate)
  {
    ...
    options: [
      ...
      { id: "organised",        label: "Organised"        },
      { id: "independent",      label: "Independent"      },
      { id: "not-sure",         label: "I'm not sure yet" },
      // Withdrawn when Q3 became a personality question. Retained so a stored
      // answer still validates and still renders with its real label.
      { id: "quiet-confidence", label: "Quiet confidence", retired: true },
      { id: "polished",         label: "Polished",         retired: true },
      { id: "effortless",       label: "Effortless",       retired: true },
      { id: "bold",             label: "Bold",             retired: true },
      { id: "sophisticated",    label: "Sophisticated",    retired: true },
      { id: "relaxed",          label: "Relaxed",          retired: true },
      { id: "powerful",         label: "Powerful",         retired: true },
      { id: "individual",       label: "Individual",       retired: true },
      { id: "understated",      label: "Understated",      retired: true },
      { id: "unexpected",       label: "Unexpected",       retired: true },
    ],
  },
  ...
  // SCREEN 11 — DRESSING HABITS (behavioural context; never scored)
  {
    ...
    options: [
      ...
      // Withdrawn — Q4 Style Exploration already captures this signal. Retained
      // so a stored answer still validates and still renders with its real label.
      { id: "play-it-safe",             label: "I tend to play it safe",                                             retired: true },
      { id: "enjoy-experimenting",      label: "I enjoy experimenting",                                              retired: true },
