...
- category: best single match. Use ACTIVEWEAR for any item that is clearly from an athletic/sportswear brand (Nike, Adidas, Under Armour, Puma, Lululemon, Gymshark, etc.) or is specifically designed for sport/gym — this includes athletic t-shirts, track jackets, zip-up sport jackets, joggers, athletic shorts, sports bras, gym leggings, regardless of silhouette. TOPS = everyday tops not from a sportswear brand: shirts, blouses, t-shirts, sweaters, polo shirts, hoodies, sweatshirts. BOTTOMS = everyday trousers, jeans, chinos, skirts, leggings — not from a sportswear brand. OUTERWEAR = non-athletic jackets, coats, blazers, bombers, parkas, trench coats, Harrington jackets (fashion/formal outerwear, not sports jackets). DRESSES includes jumpsuits and playsuits. SHOES for all footwear. ACCESSORIES = belts, hats, scarves, sunglasses. JEWELRY = watches, necklaces, rings, bracelets, earrings. Use OTHER only if truly unclassifiable.
