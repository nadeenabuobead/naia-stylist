...
- category: best single match. TOPS = shirts, blouses, t-shirts, sweaters, polo shirts, hoodies, sweatshirts, gym tops — items worn on the upper body with no outerwear function. BOTTOMS = trousers, jeans, shorts, athletic shorts, joggers, leggings, skirts, chinos — items worn on the lower body. OUTERWEAR = jackets of any kind (track jackets, zip-up jackets, Harrington jackets, bombers, denim jackets), coats, blazers, parkas — anything worn as a layer over other clothes. DRESSES includes jumpsuits and playsuits. ACTIVEWEAR = sports bras, gym leggings, compression wear — dedicated gym/sport sets where the item is not a jacket, top, or bottom. SHOES for all footwear. ACCESSORIES = belts, hats, scarves, sunglasses. JEWELRY = watches, necklaces, rings, bracelets, earrings. Use OTHER only if truly unclassifiable. When in doubt between TOPS and OUTERWEAR, choose OUTERWEAR if the item has a zip, buttons all the way down, or is clearly a layer.
