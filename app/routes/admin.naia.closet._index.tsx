// app/routes/admin.naia.closet._index.tsx
//
// Closet Intelligence list — standalone admin portal.
// Migrated from app.naia-admin.closet._index.tsx.
...
export default function ClosetIntelligenceList() {
  ...
  function buildPageUrl(p: number) {
    ...
    return `/admin/naia/closet?${sp.toString()}`;
  }
      ...
      <div className="na-card">
        ...
        <Form method="get" className="na-filters">
          ...
          <div className="na-filter-actions">
            ...
            {activeFilterCount > 0 && (
              <a href="/admin/naia/closet" className="na-filter-btn na-filter-btn--secondary">
                Clear
              </a>
            )}
          </div>
