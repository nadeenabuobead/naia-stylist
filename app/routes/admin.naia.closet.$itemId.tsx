...
//
// Closet Intelligence item detail — standalone admin portal.
// Migrated from app.naia-admin.closet.$itemId.tsx.
// Auth: requireAdminSession (internal cookie session, no Shopify).
// Data: getClosetItemDetail from closet-intelligence.server.ts — unchanged.
// Provenance display, snapshot history, review record all preserved.
...
export default function ClosetItemDetailPage() {
  ...
  return (
    <>
      {/* ── Back link — updated to /admin/naia/closet ── */}
      <Link to="/admin/naia/closet" className="na-back">
        ← Closet Intelligence
      </Link>
