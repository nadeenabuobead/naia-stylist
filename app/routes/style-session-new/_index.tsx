...
export default function QuickStyle() {
  ...
  const steps = [
    { id: 1, question: "How are you feeling?", field: "currentMood" },
    { id: 2, question: "How do you want to feel?", field: "desiredMood" },
    { id: 3, question: "What does the outfit need to work for?", field: "occasion" },
    { id: 4, question: "What does your body need from this outfit today?", field: "bodyComfortToday" },
    { id: 5, question: "What are we building the look around?", field: "stylingSource" }
  ];

  const options = {
    currentMood: ["I feel confident", "I feel tired", "I feel bloated", "I feel low-energy", "I feel playful", "I feel romantic", "I feel powerful", "I feel like I need a reset", "I feel good, I just need styling"],
    desiredMood: ["Make me feel more confident", "Make me feel more put together", "Make me feel softer", "Make me feel more powerful", "Make me feel more feminine", "Make me feel more effortless", "Make me feel more elevated", "Make me feel more attractive", "Make me feel like myself again"],
    occasion: ["Everyday / casual plans", "Work / meetings", "Dinner", "Date night", "Girls' night", "Family gathering", "Special event", "Travel day", "I'm not sure yet"],
    bodyComfortToday: ["Waist definition", "More coverage", "Something relaxed", "Something structured", "Something that elongates me", "Something that balances my shape", "Something comfortable but still elevated", "I feel bloated", "Nothing specific"],
    stylingSource: ["A nAia piece", "Something from my closet", "nAia + my closet"]
  };
