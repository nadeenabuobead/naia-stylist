            ...
            {customer && (
              <>
                ...
                <a href="/closet" style={s.iconBtn} title="My Closet">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 4a1 1 0 100 2V4zm0 2v2m-7 2l7-2 7 2-1.5 10h-11L5 8z"/></svg>
                </a>
