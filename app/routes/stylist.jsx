                  ...
                  return (
                    <div key={h.id || idx} style={{ padding: "16px 0", borderBottom: idx < 9 ? "1px solid #e8e4df" : "none" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        ...
                        <button style={{ ...s.outlineBtn, fontSize: "10px", padding: "6px 12px" }} onClick={() => { setStylingResult(typeof h.result === "string" ? h.result : ""); setMood(h.mood || ""); setFeeling(h.feeling || ""); setEvent(h.event || ""); setShowHistory(false); setStep(8); }}>View</button> setStylingResult(typeof h.result === "string" ? h.result : ""); ...
                      </div>
