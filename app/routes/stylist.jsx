...
function TrendReportDisplay({ report, query }) {
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(12);
    doc.text('PERSONALIZED TREND REPORT', 105, 30, { align: 'center' });
    doc.setFontSize(10);
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.setFontSize(8);
      doc.setTextColor(138, 127, 117);
      doc.text(`Generated by nAia • ${new Date().toLocaleDateString()}`, 105, 285, { align: 'center' });
      doc.text(`Page ${i} of ${pageCount}`, 105, 290, { align: 'center' });
    }
    
    doc.save(`${query.replace(/\s+/g, '-').toLowerCase()}-personalized-report.pdf`);
  };
    ...
    <div style={{ background: "#fff", border: "1px solid #d4cfc9", borderRadius: "2px", padding: "24px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", paddingBottom: "12px", borderBottom: "2px solid #1a1816" }}>
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          <button onClick={() => navigator.clipboard.writeText(report)} style={{ fontSize: "10px", padding: "6px 12px", background: "transparent", color: "#1a1816", border: "1px solid #1a1816", borderRadius: "4px", cursor: "pointer", fontFamily: '"Cormorant Garamond", Georgia, serif' }}>
            Copy
          </button>
          <button onClick={downloadPDF} style={{ fontSize: "10px", padding: "6px 12px", background: "transparent", color: "#1a1816", border: "1px solid #1a1816", borderRadius: "4px", cursor: "pointer", fontFamily: '"Cormorant Garamond", Georgia, serif' }}>
            Download PDF
          </button>
        </div>
      </div>
      ...
      {trendLensContent && (
        <div style={{ background: "#f5f2ee", padding: "16px", borderRadius: "2px", marginBottom: "24px", borderLeft: "3px solid #1a1816" }}>
          <h4 style={{ fontSize: "11px", letterSpacing: "0.15em", textTransform: "uppercase", color: "#8a7f75", margin: "0 0 12px" }}>YOUR TREND LENS</h4>
          <div style={{ fontSize: "14px", lineHeight: 1.7, fontStyle: "italic" }}>
