...
const css = `
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  /* Header — exact parity with nadine-storefront SiteNav */
  ...
  .psl-sitenav-links { display: none; align-items: center; gap: 28px; }
  @media (min-width: 768px) { .psl-sitenav-links { display: flex; } }
  .psl-sitenav-link {
    font-family: 'Inter', sans-serif; font-size: 0.72rem; letter-spacing: 0.025em;
    color: rgba(26,17,9,0.80); text-decoration: none;
  ...
  .psl-header-logo {
    ...
    letter-spacing: 0.02em; line-height: 0.88; text-transform: uppercase; color: #1a1109;
    text-decoration: none; white-space: nowrap;
  }
  .psl-header-right {
    display: flex; align-items: center; gap: 20px; color: rgba(26,17,9,0.80);
  }
  .psl-personal-link {
